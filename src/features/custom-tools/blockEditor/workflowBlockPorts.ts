...
function input(id: string, label: string, side: WorkflowInputPortSide) {
  return { id, label, side };
}

function output(id: string, label: string) {
  return { id, label };
}
